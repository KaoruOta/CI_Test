...
public:
  ...
  void init();
  //  void setCommand(float velocity, int forward, float yawratecmd, signed int tail_ang_req, float yawrate, bool forward_curve_mode, bool tail_stand_mode, bool tail_lug_mode, bool gyro_offset_plus, bool falling_seesaw, bool hilling_seesaw);
  void setCommand(float velocity, int forward, float yawratecmd, signed int tail_ang_req, float yawrate, bool forward_curve_mode, bool tail_stand_mode, bool tail_lug_mode, bool gyro_offset_en, int gyro_offset_value, bool pwm_ctl_en, int pwm_ctl_value);
  ...
  int prev_omega           = 0;
  int prev_right_wheel_enc = 0;
  int prev_left_wheel_enc  = 0;

  int correct_omega           = 0;
  int correct_right_wheel_enc = 0;
  int correct_left_wheel_enc  = 0;
  //----180908
...
private:
  ...
  bool  mTail_lug_mode;
  //  bool  mGyro_offset_plus;
  //  bool  mGyro_offset_minus;
  //  bool  mHilling_seesaw;

  bool mGyro_offset_en;
  int  mGyro_offset_value;
